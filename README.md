...
El ACP es una técnica de transformación de datos usada en percepción remota usada cuando existe una alta correlación entre variables en este caso las bandas, que permite resumir en un número más pequeño, fácil de interpretar y de procesar y que  en conjunto trata explican la mayor parte de la variabilidad (Good et al., 2012). El componente principal número uno representa la proporción máxima de la varianza del stack de las bandas y los componentes siguientes ortogonales a este van representando una proporción de la varianza restante (Zhao y Maclean, 2000; Viscarra Rossel y Chen, 2011).   
</A> </font></p> 
