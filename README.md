...
<p style="text-align: justify;font-family: times"><FONT COLOR=#283747><FONT SIZE=4>Los parámetros usados despúes de realizar varias pruebas fueron para el ancho de banda para la generación de semillas fue de 2.5 y la generalización 1, un ejemplo del resultado se puede obserbar en la figura 3
